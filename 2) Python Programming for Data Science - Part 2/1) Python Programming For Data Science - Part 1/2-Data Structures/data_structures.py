...
#######################
# split: karakter dizisini parçalara ayırır. (output = list)
#######################
"Hello AI Era".split()

#######################
# strip("o"): baştaki ve sondaki "o" karakterini siler. " " boşluk karakteri siler. 
#######################
" ofofo ".strip()
"ofofo".strip("o")
...
# copy:     tüm elemanları kopyalar.
# count:    elemanların sayısını verir.
# extend:   başka bir liste ekler.
# index:    elemanın indexini verir.
# insert:   indexe ekler.
# pop:      "index"e göre elemanı siler.
# remove:   elemanı siler
# (pop ve remove arasındaki fark: pop silinen indexteki elemanı döndürür, remove ise döndürmez.)
...
# dict: yöntemiyle de sözlük oluşturulabilir.
MLB_team = dict([
     ('Colorado', 'Rockies'),
     ('Boston', 'Red Sox'),
     ('Minnesota', 'Twins'),
