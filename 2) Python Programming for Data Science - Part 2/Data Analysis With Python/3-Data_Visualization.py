...
# Kategorik değişken: sütun grafik => seaborn: countplot, matplotlib: barplot
# Sayısal değişken: hist, boxplot => 2 side dağılım gösterir. boxplot aykırı değer de gösterir.
