...
# grab_col_names: değişkenleri yakalayan fonksiyon
...
# cat_summary: tüm categorical değişkenler için fonkisyon
...
# num_summary: tüm numerical değişkenler için fonkisyon
